...
export default function PaginaConsultaSeguimiento() {
  return (
    <section className="mx-auto flex max-w-2xl flex-col gap-4 px-4 py-6">
      ...
      <p className="text-slate-600">Escribe el codigo de seguimiento (empieza con E-) que te dieron al enviarla.</p>
      <ConsultaPorCodigo etiqueta="Codigo de seguimiento" ejemplo="E-XXXXXXXX" ruta="/seguimiento" />
    </section>
  );
}
