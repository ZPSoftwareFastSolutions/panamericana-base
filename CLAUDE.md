...
0e. **Verificar la guía v1.6** (extraer el ejemplo `choferes`, lint, pruebas, build y API; luego retirarlo) y **regenerar `compartir/GUIA_DESARROLLO_PANAMERICANA.md`** antes de enviarla al equipo. El 26/09 el clasificador de permisos bloqueó el script de extracción: hace falta autorizarlo o hacerlo a mano.
